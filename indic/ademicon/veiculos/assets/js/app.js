(() => {
    ...
    },
    {
        ...
        "status": "Parcela divulgada: R$ 1.161,99",
    ...
    async function loadCampaigns() {
        ...
        try {
            ...
            console.warn(
                "Campanhas embutidas utilizadas:",
                error
            );
        }
    ...
    function selectCampaign(
        ...
        document
            .getElementById(
                "selected-campaign-credit"
            )
            .textContent =
                "Crédito: " +
                state.campaign.credit;
    ...
    async function sendLeadToWorker(
        payload
    ) {
        if (
    ...
    async function sendWhatsApp() {
        ...
        try {
            await sendLeadToWorker(
                leadPayload
            );
        } catch (error) {
            console.warn(
                "Falha no Worker. WhatsApp preservado:",
                error
            );
        }
